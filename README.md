...
local DEFAULT = {
  ...
  ---@field layout Yat.Config.Sidebar.Layout
  sidebar = {
    ---@class Yat.Config.Sidebar.PanelLayout.Panel
    ---@field panel Yat.Panel.Type
    ---@field height? integer|string

    ---@class Yat.Config.Sidebar.PanelLayout
    ---@field panels Yat.Config.Sidebar.PanelLayout.Panel[]
    ---@field width integer
    ---@field auto_open boolean

    ---@class Yat.Config.Sidebar.Layout
    ---@field left Yat.Config.Sidebar.PanelLayout
    ---@field right Yat.Config.Sidebar.PanelLayout
    layout = {
      left = {
...
<summary><b>Git Status panel actions:</b></summary>
...
<summary><b>LSP Symbols panel actions:</b></summary>
...
<summary><b>Buffers panel actions:</b></summary>
...
`vim.api` functions calls, since they might error when called from a `vim.loop` callback. The is remedied
by using `vim.schedule(...)`, or the wrapped `async` variant:
```lua
panel.root:refresh()
...
specific to `ya-tree`, in the `ya-tree.ui.nui` package. There is also a `wrap`ped variant for when only
