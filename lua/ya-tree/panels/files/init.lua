...
function M.setup(config)
  ...
  M.renderers.directory, M.renderers.file = utils.create_renderers("files", renderers.directory, renderers.file)
  ...
  M.keymap = utils.create_mappings("files", config.panels.files.mappings.list, M.supported_actions)
