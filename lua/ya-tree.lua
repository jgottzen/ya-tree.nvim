...
function M.setup(opts)
  ...
  api.nvim_create_user_command("YaTreeClose", M.close, { desc = "Closes the tree view" })
  api.nvim_create_user_command("YaTreeToggle", M.toggle, { desc = "Toggles the tree view" })
  api.nvim_create_user_command("YaTreeFocus", M.focus, { desc = "Focuses the tree view, opens it if not open" })
